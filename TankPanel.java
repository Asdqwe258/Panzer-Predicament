...
//Period 5	
   ...
   public class TankPanel extends JPanel
   {
      ...
      private Map map;
      private Tank pd; //player1
      private Tank p2;//player2
       private Bullet ball, ball2, ball3, ball4, ball5, ball6, ball7, ball8, ball9, ball10; //instantiates all the ammo
      ...
      public TankPanel(Map m)
      {
         ...
         w.start();
         pd = new Tank(1);//initializes player1
         ball = new Bullet(100, 100, 0, Color.BLACK, 0);//intializes player1's ammo
         ball.setdx(0);
         ball.setdy(0);
         ball2 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball2.setdx(0);
         ball2.setdy(0);
         ball3 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball3.setdx(0);
         ball3.setdy(0);
         ball4 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball4.setdx(0);
         ball4.setdy(0);
         ball5 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball5.setdx(0);
         ball5.setdy(0);
         	ball.setfirenum(1);
         	ball2.setfirenum(1);
         ...
         p2 = new Tank(2); //initializes player2
         ball6 = new Bullet(100, 100, 0, Color.BLACK, 0);//initializes player2's ammo
         ball6.setdx(0);
         ball6.setdy(0);
         ball7 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball7.setdx(0);
         ball7.setdy(0);
         ball8 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball8.setdx(0);
         ball8.setdy(0);
         ball9 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball9.setdx(0);
         ball9.setdy(0);
         ball10 = new Bullet(100, 100, 0, Color.BLACK, 0);
         ball10.setdx(0);
         ball10.setdy(0);
         	ball6.setfirenum(1);
         	ball7.setfirenum(1);
  ...
  if(ball6.getfirenum()==1)
    ...
    private void collide(Bullet b, Tank p)
      {
